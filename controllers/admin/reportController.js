...
module.exports = {
    featurePlanIncomeReport: async (req, res) => {
        try {
            global.currentModule = 'Report';
            global.currentSubModule = 'Feature Plan Income Report';
            global.currentSubModuleSidebar = 'featurePlanIncomeReport';
            ...
            const headerColumns = Object.values({
                ...
                orderNetAmount: 'Plan Net Amount Total',
                // noOfQty: 'No. of QTY',
                taxCharged: 'Tax Charged Total',
        ...
        try {
            ...
            const data = listing.map((order, index) => {
                return Object.values({
                    ...
                    planPurchased: order.featurePlan.name,
